...
> [!NOTE]
> UnattendedWinstall has been tested and optimized for personal use. For those unsatisfied or interested in customizing further, consider creating your own answer file using: </br> - [nonsense Unattend Generator](https://github.com/o9-9/nonsense). </br> - [Schneegans Unattend Generator](https://schneegans.de/windows/unattend-generator/).

### Versions

[![Version 3 Release (Latest)](https://img.shields.io/badge/Version-3.0.0%20Latest-0078D4?style=for-the-badge&logo=github&logoColor=white)](https://github.com/o9-9/UnattendedWinstall/releases/tag/v3.0.0)
[![Version 2 Release](https://img.shields.io/badge/Version-2.1.0-0078D4?style=for-the-badge&logo=github&logoColor=white)](https://github.com/o9-9/UnattendedWinstall/releases/tag/v2.1.0)
[![Version 1 Release](https://img.shields.io/badge/Version-1.0.0-FFA500?style=for-the-badge&logo=github&logoColor=white)](https://github.com/o9-9/UnattendedWinstall/releases/tag/v1.0.0)
...
[![Join the Discussion](https://img.shields.io/badge/Join-the%20Discussion-2D9F2D?style=for-the-badge&logo=github&logoColor=white)](https://github.com/o9-9/UnattendedWinstall/discussions)
...
- Applies the following Optimizations:
  ...
  - Power Settings (Imports and applies the nonsense Power Plan for better performance)
...
> [!TIP]
> Use [nonsense](https://o9ll.com/) once Windows is installed *(can be installed using the 'Install nonsense' desktop shortcut)* to install software, re-apply or revert settings and manage your Windows apps and settings.
>
> It can also be used to achieve the same experience UnattendedWinstall provides on an existing Windows installation without reinstalling Windows.
...
### Using o9's WIMUtil in nonsense (Highly Preferred)

To use **WIMUtil**, follow these steps:

1. Download and install nonsense from [o9ll.com](https://o9ll.com/) or [GitHub](https://github.com/o9-9/nonsense/releases/latest).

2. Launch nonsense, click on the "Advanced Tools" navigation button (bottom left) and select WIMUtil.

Once launched, **WIMUtil** guides you through a wizard:

1. **Select or Download Windows ISO**
2. **Add Latest UnattendedWinstall Answer File Automatically, create one with nonsense or select your own file**
...
- Use [nonsense](https://o9ll.com/), it contains the same settings as UnattendedWinstall.
...
- Feature updates are delayed for a year; however, security and driver updates continue as usual. If you want to completely disable updates, use [nonsense](https://o9ll.com/).
...
<details>
  ...
  > [!TIP] </br>
  > You can use WIMUtil in [nonsense](https://o9ll.com/) to extract and add the drivers from your current operating system to the Windows installation media. These drivers should then be installed automatically during the Windows installation process, preventing any internet connection issues.
